...
gk_caltrim <- function(data,
  ...
  pers_h[, w_old := w]
  ozet_veri <- pers_h %>% select("ILKAYITNO", "ALTORNEK", "BLOKNO", "bulten", "IBBS_1", "IBBS_2", "nur", "KIR_KENT", "DURUM", "IKFA4", "PF_hhbkirkent", "hhb", "fk_cinsi", "gender", "fk_yas", "age_g", "AG", "duzfakto", "w")
